...
public class SetNewPassword extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		verificationCode = (EditText) findViewById(R.id.edit_new_password_input_code);
		newPassword = (EditText) findViewById(R.id.edit_new_password_password);
		layoutTime = (RelativeLayout) findViewById(R.id.layout_new_password);
		time = (TextView) findViewById(R.id.text_new_password_time);
	...
	OnClickListener onClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			switch (v.getId()) {
			case R.id.image_new_password_return:// 返回上一個頁面
				finish();
				break;
			case R.id.button_new_password_determine:// 確定按鈕
